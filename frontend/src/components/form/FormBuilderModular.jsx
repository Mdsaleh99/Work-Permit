...
const FormBuilderModular = ({ 
        ...
        if (isEditingMode && workPermitId) {
            const loadSubmissions = async () => {
                ...
                try {
                    ...
                    console.log('FormBuilderModular - Loaded submissions:', submissions);
                    if (submissions?.data && submissions.data.length > 0) {
                        // Get the latest submission
                        const latestSubmission = submissions.data[0];
                        console.log('FormBuilderModular - Latest submission:', latestSubmission);
                        setSubmittedData(latestSubmission.answers);
                    } else {
                        console.log('FormBuilderModular - No submissions found');
    ...
    if (showPrintView) {
        ...
        console.log('FormBuilderModular Print View - Final formData:', finalFormData);
        console.log('FormBuilderModular Print View - Submitted data:', submittedData);

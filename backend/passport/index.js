...
try {
    // serialize and deserialize is important for session management
    // serialize means saving the users data inside the session
    // deserialize means retriveing the users data from the session when needed
    // here next is done i mean next as done function name
